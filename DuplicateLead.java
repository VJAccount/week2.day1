...
public class DuplicateLead {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		if(newTitle.contains("View Lead")) {
			System.out.println("Lead duplication successful");
		}
		else
			System.out.println("Lead duplication NOT successful");
		//Thread.sleep(3000);
		driver.close();
